...
Has basic support for almost all built in functions, and comments. I didn't go much farther then that however, and Syntax highlighting for brackets, numbers, variables, etc is left out of this current version. I also left out highlighting for plotting commands, mainly because they have issues when running in kate's built in runtime.
